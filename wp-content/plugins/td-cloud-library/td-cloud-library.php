...
Author: tagDiv
Version: 1.7 | built on 16.06.2021 12:00
...
//hash
define('TD_CLOUD_LIBRARY', '45456ad3a6d583e9cee0a9fe2cdd86cb');
...
if ( TDB_DEPLOY_MODE == 'dev' ) {
	if ( 'cloud.tagdiv.com' === $_SERVER[ 'SERVER_NAME' ] ) {
	...
	if ( 'work-cloud.tagdiv.com' === $_SERVER[ 'SERVER_NAME' ] ) {
		add_action( 'admin_menu', function () {
			add_menu_page(
				'IP Cloud - Work',
				'IP Cloud - Work',
