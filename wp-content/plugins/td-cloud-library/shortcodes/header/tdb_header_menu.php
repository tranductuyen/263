...
//            echo '</pre>';
    ...
    function inner( $menu, $menu_type = '' ) {
        ...
        if( $main_sub_icon != '' ) {
            if( base64_encode( base64_decode( $main_sub_icon ) ) == $main_sub_icon ) {
                $main_sub_icon_html = '<span class="tdb-menu-more-subicon tdb-menu-more-subicon-svg">' . base64_decode( $main_sub_icon ) . '</span>';
            } else {
                $main_sub_icon_html = '<i class="tdb-menu-more-subicon ' . $main_sub_icon . '"></i>';
            }
        }
