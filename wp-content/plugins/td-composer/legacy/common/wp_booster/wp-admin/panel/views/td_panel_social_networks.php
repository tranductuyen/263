...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>
            Used for displaying data from business pages you own or manage through your account, like fb page likes or ig page followers count.<br>
            Use the button below to connect to your facebook account and authorize our application to share data from business pages you own or manage through your account.
        </p>
    </div>
...
<div class="td-box-row">
    <div class="td-box-control" style="padding-bottom: 32px;">
        ...
        <a class="button button-secondary td-fb-add-account <?php //echo $disabled ?>"
           href="https://www.facebook.com/dialog/oauth?client_id=198698130522676&redirect_uri=<?php echo $td_facebook_api_redirect_uri ?>&scope=pages_show_list,pages_read_engagement&state=<?php echo $state ?>"
           style=""
        ...
        <div class="td-box-control td-box-control-fb-account-pages">
	        ...
	        if ( !empty($td_options_fb_connected_account) ) {
		        ...
		        ?>
                <p class="td-no-fb-account-message"><strong>No fb account connected!</strong></p>
		        <?php
	        }
    ...
    <div class="td-box-control" style="padding-bottom: 32px;">
        ...
        <div class="td-box-control td-box-control-inst-account" style="clear: left;">
			...
			if ( ! empty( $connected_account ) ) {
				...
				?>
                <p class="td-no-account-message"><strong>No ig personal account connected!</strong></p>
				<?php
			}
			?>
        </div>
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>
            Used for displaying a feeds from a "Business" or "Creator" Instagram account.<br>
    ...
    <div class="td-box-control" style="padding-bottom: 32px;">
        ...
        <div class="td-box-control td-box-control-ig-business-accounts">
            ...
            if ( !empty($td_options_instagram_business_accounts) ) {
		                ...
		                if ( isset( $instagram_business_account['error'] ) ) {
                            ...
                            <div class="about-wrap">
                                <div class="td-ig-business-account-wrap td-ig-business-account td-ig-id-<?php echo $instagram_business_account_id ?>">
                                    <div class="td-ig-business-account-photo"><img src="<?php echo $profile_picture ?>" alt="ig_business_acc_profile_pic"></div>
	            ...
	            ?>
                <p class="td-no-ig-business-accounts-message"><strong>No ig business accounts connected!</strong></p>
	            <?php
            }
