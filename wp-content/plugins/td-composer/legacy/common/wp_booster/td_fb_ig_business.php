...
class td_fb_ig_business {
	...
	function td_fb_account_data_for_token( $access_token, $user_id ) {
		...
		if ( isset( $page_error ) && isset( $page_error->errors ) ) {
			...
			$error_message .= '<p><b>Could not find Business Profile</b><br/> It looks like this Facebook account is not currently connected to an Instagram Business profile.</p>';
			$error_message .= '<pre style="white-space: pre-wrap; word-break: break-all;"><b>$pages_data:</b><br>';
