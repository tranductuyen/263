<div class="td-footer-wrapper td-footer-container td-container-wrap td-footer-template-4 <?php echo td_util::get_option('td_full_footer'); ?>">
    <div class="td-container">
        ...
        <div class="td-pb-row">
            ...
            <div class="td-pb-span12">
                ...
                require_once('td_footer_extra.php');
