...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>Select the theme general color.</p>
    </div>
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>Select the menu bar background color.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::color_picker(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>Select the menu and search icons color.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::color_picker(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>Select the gradient for the menu panel background.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::color_picker(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>Select the text & icons color.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::color_picker(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>Select the background and text color.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::color_picker(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">BACKGROUND COLOR</span>
        <p>Select the footer background color.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::color_picker(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>Select the footer text color.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::color_picker(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">BACKGROUND COLOR</span>
        <p>Select the sub-footer background color.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::color_picker(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">TEXT COLOR</span>
        <p>Select the sub-footer text color (Copyright).</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::color_picker(array(
