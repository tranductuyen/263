...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>This ad appears below the menu.</p>
    </div>
    <div class="td-box-control-full">
        <?php
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>Select after how many posts the loop ad is displayed. By default, the ad appears after 5 posts.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::input(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>This ad appears on the single pages on top of the post content.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::textarea(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>This ad appears on the single pages inside the post content.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::textarea(array(
...
<div class="td-box-row">
    <div class="td-box-description">
        ...
        <p>Select after how many paragraphs the ad is displayed. The theme analyzes the content of each post and injects an ad after the selected number of paragraphs.</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::input(array(
